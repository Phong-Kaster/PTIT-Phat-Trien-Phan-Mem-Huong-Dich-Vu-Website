...
<html id="locale" lang="<?= ACTIVE_LANG ?>">
   ...
   <body>
      ...
      <?php 
         $Nav = new stdClass;
         $Nav->activeMenu = "expensecategory";
      ...
      <div class="main-panel"><!-- right screen -->
         ...
         <!-- content -->
         <?php require_once(APPPATH.'/views/fragments/expensecategory.fragment.php'); ?>
         <!-- END content -->
      ...
      $(document).ready(function() {
         ...
         $("#formadd").validate({
            submitHandler: function(forms) {
               ...
               submitForm($(forms), $('#add'), "<?= APIURL ?>/expensecategories", "POST", data);
               return false;
            }
         });
         ...
         $("#formedit").validate({
            submitHandler: function(forms) {
               ...
               submitForm($(forms), $('#edit'), "<?= APIURL ?>/expensecategories/" + id, "PUT", data);
               return false;
            }
         });
         ...
         $('#edit').on('show.bs.modal', function(e) {
            ...
            $.ajax({
               type: "GET",
               url: "<?= APIURL ?>/expensecategories/" + id,
               success: function(resp) {
