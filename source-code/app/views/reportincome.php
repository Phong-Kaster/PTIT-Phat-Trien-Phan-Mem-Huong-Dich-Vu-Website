...
<html id="locale" lang="<?= ACTIVE_LANG ?>">
   ...
   <body>
      ...
      <div class="main-panel">
        ...
        <!-- content -->
        <?php require_once(APPPATH.'/views/fragments/reportincome.fragment.php'); ?>
        <!-- end Content -->
         ...
         <script>
            $(document).ready(function() {	
                  ...
                  ajax: {
            				...
            				data: function (d) {
            					...
            					d.search = $('input[name=name]').val();
											d.account = $('select[name=incomeaccount]').val();
            	...
            	$.ajax({
                    type: "GET",
                    url: "<?= APIURL."/home/incomevsexpense?type=income&date=month" ?>",
                    dataType: "json",
                    data: {},
                    success: function (resp) {
