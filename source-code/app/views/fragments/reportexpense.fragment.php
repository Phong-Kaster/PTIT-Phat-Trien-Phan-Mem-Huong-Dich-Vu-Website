            ...
            <div class="container-fluid">
               <div class="row">
                  <div class="col-lg-12 col-md-11">
                     <div class="card">
                        <div class="header">
                           <h4 class="title"><?= __("Expense Reports") ?></h4>
                        </div>
                           ...
                           <div class="content">
                              <div class="row">
                                 ...
                                 <div class="col-md-4 mt-4 mt-md-2">
                                    ...
                                    <select id="expensecategory" class="form-control" name="category" data-url="<?= APIURL ?>/expensecategories">
                                       <option value=""><?= __("Select a Category") ?></option>
                                    </select>
                                 </div>
                                 <div class="col-md-4 mt-4 mt-md-2">
                                    <label><?= __("Account" ) ?></label>
                                    <select id="expenseaccount" class="form-control" name="expenseaccount" data-url="<?= APIURL ?>/accounts">
                                    <option value=""><?= __("Select a Category") ?></option>
                                    </select>
                                 </div>
                              </div>
               ...
               <div class="row">
                  <div class="col-lg-6">
                     <div class="card">
                        <div class="header">
                           <div class="pull-left">
                              <h5><b><?= __("12 Monthly Expense Chart") ?></b></h5>
                           </div>
                  ...
                  <div class="col-lg-6">
                     <div class="card">
                        <div class="header">
                           <h5><b><?= __("Expense By Category") ?> <?= date("Y") ?></b></h5>
                        </div>
                        <div class="content">
